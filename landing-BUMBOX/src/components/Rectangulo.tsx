function Rectangulo() {
    return (
        <div className="rectangulo">
            <img src="src/components/img/Rectangle 3.png" alt="Rectángulo" />
            <span className="text">
                ...
                Reproduction in whole or in part, or translation without written permission is prohibited. All rights reserved 2021.
            </span>
        </div>
    );
}
